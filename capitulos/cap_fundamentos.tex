...
\item \textbf{Na instrução}: Assumindo que um programa de computador são um conjunto de instruções interpretados pelo processador, pode-se combinar esse conjunto de instruções em blocos que podem ser executados de forma concorrente sem alterar o resultado final;

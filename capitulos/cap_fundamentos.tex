...
O paralelismo, no entanto, adicionou novas complexidade ao sistema antigo (sequencial), como a distribuição eficiente pelos vários processadores e a sincronização de tarefas. O modelo ideal seria o qual todos os processadores trabalhariam de forma iguais sem sobrecarga (\textit{overhead}) de nenhum. O problema de si

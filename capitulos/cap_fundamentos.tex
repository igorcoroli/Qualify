...
{\color{red} A idéia aqui é falar um pouco sobre os outros métodos mas apronfundar no OpenMP e mostrar os "possíveis" usos e/ou compatibilidade com sistemas embarcados, pricipalmente no Android (já achei um artigo sobre isso)}

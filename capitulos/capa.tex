...
\newcommand{\tittese}{%
	DETECÇÃO DE PONTOS FIDUCIAIS EM FACES HUMANAS UTILIZANDO MÁQUINA DE VETORES SUPORTE %mudar
}

\newcommand{\titteseing}{%
	Fiducial Points Detection in Human Faces using Support Vectors Machine %mudar
}

\newcommand{\authorof}{%
	Luiz Eduardo Sales e Silva \\ %mudar
	\vspace{0.8ex}}

\newcommand{\dateof}{%
	Agosto de 2015 %mudar
	\vspace{0.8ex}}
...
\newcommand{\coadvisorof}{%
	Prof. D.Sc. Fulano %mudar % <---- deixar em branco se não tiver coorientador !!!!!
	\vspace{0.8ex}}
\coadvisor{}{\coadvisorof}{}{}

\newcommand{\examinerofa}{%
	Prof. D.Sc. José %mudar
	\vspace{0.8ex}}

\newcommand{\examinerofb}{%
	Prof. D.Sc. Maria %mudar
	\vspace{0.8ex}}
...
\examinerofa \\
Universidade Federal do Rio de Janeiro (UFRJ) %mudar (local de trabalho examinador A)
\vspace{2em}
...
\vspace*{\stretch{1}}
\noindent \textsf{Palavras-chave:} reconhecimento de padrões, detecção de pontos fiduciais, máquina de vetores suporte, grid de parâmetros e C-SVC. %mudar
...
\vspace*{\stretch{1}}
\noindent \textsf{Keywords:} pattern recognition, fiducial points detection, support vectors machine, parameters grid and C-SVC. %mudar

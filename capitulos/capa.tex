...
\newcommand{\coadvisorof}{%
	Prof. D.Sc. XXX %mudar % <---- deixar em branco se não tiver coorientador !!!!!
	\vspace{0.8ex}}
...
Dissertação apresentada ao Programa de P\'os-Gradua\c{c}\~ao em Engenharia Elétrica da Universidade Federal do Amazonas, como requisito parcial para obten\c{c}\~ao do t\'{\i}tulo de Mestre em Engenharia Elétrica na \'area de concentra\c{c}\~ao Sistemas Embarcados.
}}
...
\vspace*{\stretch{1}}
\noindent \textsf{Palavras-chave:} XXX, XXX, XXX, XXX, XXX. %mudar
